...
from .views import home, create_set, flashcard_practice, wordset_detail, exercise_history, fill_in_the_gap_practice
...
urlpatterns = [
    ...
    path('wordset/<int:wordset_id>/fill-in-the-gap/', fill_in_the_gap_practice, name='fill_in_the_gap_practice'),
]
